# Individual Project Plan – Roshini
...
1. **Planning and Database:** Understand the project requirements and create a database to store user, farm, and crop information.
2. **Backend Development:** Develop the main functions that handle user, farm, and crop information and make sure they work correctly.
3. **Frontend Development:** Build the website pages and connect them with the backend so users can interact with the system.
4. **Testing and Final Submission:** Test all features, fix any problems, ensure everything works properly, and submit the completed project.
