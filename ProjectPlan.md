...
1. Backend REST APIs (Spring Boot CRUD)
...
1. Frontend Screens (React)
2. Login Page: Restricts dashboard views based on user permissions (`Admin` vs. `Guest`).
3. Farms Dashboard: Grid view showing all registered farms and their locations.
4. Management Modals: Forms to quickly **Add User**, **Add Farm**, and **Add Crop Data**.
